...
export default function Header() {
  return (
    <div className="w-11/12 m-auto py-8 text-center flex flex-col justify-center gap-8 lg:w-full lg:flex-row-reverse lg:justify-end lg:items-center lg:gap-16">
